...
import yv.tils.dc.mods.discord.embedManager.whitelist.AccountAdded
import yv.tils.dc.mods.discord.embedManager.whitelist.AccountAlreadyListed
import yv.tils.dc.mods.discord.embedManager.whitelist.AccountCanNotExist
import yv.tils.dc.mods.discord.embedManager.whitelist.AccountChange
import yv.tils.dc.mods.discord.embedManager.whitelist.AccountCheckError
import yv.tils.dc.mods.discord.embedManager.whitelist.AccountNotFound
import yv.tils.dc.mods.discord.embedManager.whitelist.RoleHierarchyError
import yv.tils.dc.utils.MojangAPI
        ...
        try {
            ...
            if (statusCode == HttpURLConnection.HTTP_OK) {
                if (ImportWhitelist().reader(dc = userID).contains(userID)) {
                    ...
                    try {
                        var role = DiscordConfig.config["whitelistFeature.role"].toString()
                        role = role.replace(" ", "")
